...
import seneca.judges.HOSECodeJudge;
 ...
 */
public class HOSECodeJudgeConfigurator extends JudgeConfigurator {

    private static final long serialVersionUID = 1L;
    HOSECodeJudge hoseCodeJudge = null;
    private boolean isAutoConfigured = false;

    public HOSECodeJudgeConfigurator(SenecaDataset sd) {
        super(sd, (HOSECodeJudge) sd.getJudge("HOSECodeJudge"));
        this.hoseCodeJudge = (HOSECodeJudge) sd.getJudge("HOSECodeJudge");
    ...
    public void autoconfigure() {
        ...
        hoseCodeJudge.setCarbonShifts(shifts);
    ...
    protected String getMessage() {
        ...
        m.append("<html>");
        m.append("<b>HOSECodeJudge</b> uses about 600 1-sphere HOSE codes ");
